...
function searchId(id){
    fetch(`https://www.superheroapi.com/api.php/10219098893255282/search/${id}`)
...
function searchIdComicVine(name){
    console.log(name)
    fetch(`https://comicvine.gamespot.com/api/search/?api_key=aead5e3fc45f4a8aaade28c0cdc6a27210eb7b39&format=json&sort=name:asc&resources=issue&query=${name}`)
     .then(function(response) {
       return response.json();
     })
     .then(function(json) {
